...
// --- MAIN COMPONENT ---
const JBBTCoursePage: React.FC<JBBTCoursePageProps> = ({}) => {
    ...
    },
{
  ...
  content:
    "Yes, JBBT is fully focused on web applications. You will learn beginner-friendly web bug hunting with AI-powered guidance to help you understand and practice real-world web vulnerabilities easily.",
},
            ...
            >
              ...
              <div>
                ...
                <p className="mt-3 text-gray-200 text-sm sm:text-base">
                  The JBBT is recognized by leading bug bounty platforms and security firms worldwide. Gain the <strong>credibility and deep technical skills</strong> required to stand out in the competitive field of offensive security.
                </p>
              </div>
            </motion.div>
          </Section>
            ...
            <div className="p-6 sm:p-8 rounded-lg flex flex-col sm:flex-row items-center gap-6 sm:gap-8 max-w-4xl mx-auto text-center sm:text-left">
              ...
              <div>
                ...
                <p className="mt-3 sm:mt-4 text-gray-300 text-sm sm:text-base">
                  In JBBT, you don’t need to know a single thing about hacking or coding. We’ll take you step by step — from beginner level to finding your first real-world bug. This isn’t just a course; it’s your launchpad into ethical hacking.
                </p>
              </div>
            </div>
          </Section>
