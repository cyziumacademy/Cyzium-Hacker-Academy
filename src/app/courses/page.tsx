...
const courses: Course[] = [
    { title: "Junior Bug Bounty Hunter", path: "jbbh", category: "Bug Bounty Hunter", description: "Learn the fundamentals of ethical hacking and penetration testing.", image: "/jbbh.png" },
    { title: "Certified Bug Bounty Hunter", path: "cbbt", category: "Bug Bounty Hunter", description: "Master the art of writing secure code and preventing vulnerabilities.", image: "/cbbt.png" },
    { title: "Certified Bug Bounty Expert", path: "cbbe", category: "Bug Bounty Hunter", description: "Dive deep into malware analysis and reverse engineering techniques.", image: "/cbbe.png" },
    { title: "Network Security", path: "cna", category: "Networking", description: "Understand and implement robust network security protocols.", image: "/cna.png" },
    { title: "Certified Cloud Security Analyst", path: "ccsa", category: "Cloud security", description: "Advanced techniques for finding and exploiting vulnerabilities.", image: "/ccsa.png" },
    { title: "Certified Ai Security Specialist", path: "cass", category: "Ai security", description: "Secure cloud environments and infrastructure.", image: "/cass.png" },
    { title: "Certified Professional Bug Hunter", path: "cpbh", category: "Bug Bounty Hunter", description: "Secure cloud environments and infrastructure.", image: "/cpbh.png" },
];
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-5 items-center justify-items-center">
        {selectedPath.certifications.map((cert, idx) => (
          <React.Fragment key={idx}>
            <div className="rounded-lg overflow-hidden h-24 sm:h-28 w-full max-w-[130px]">
              <img
                src={cert.image}
                alt={cert.name}
