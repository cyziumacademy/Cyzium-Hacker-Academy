...
return (
  <div className="relative text-white font-sans overflow-x-hidden">
    ...
    <div className="fixed top-0 left-0 w-full h-full z-0">
      {/* Base gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0A1AFF] via-[#001F3F] to-[#0047AB]" />

      {/* Overlay red-blue glow */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-800/90 via-transparent to-blue-800/40 mix-blend-overlay" />
...
<h1 className="text-4xl sm:text-6xl md:text-8xl font-extrabold tracking-tight text-white mt-12">
  Certified Network <span className="text-blue-600">Associate</span>
</h1>
...
<p className="text-base sm:text-xl text-gray-300 leading-relaxed md:w-[70%]">
 The Certified Network Associate (CNA) program is a complete training course designed for individuals beginning their journey in networking and IT infrastructure, with no prior experience required. 
 In this course, you will learn how computer networks operate, how data travels across the internet, and how devices communicate securely and efficiently. 
 You’ll be guided step by step through core networking concepts — from understanding IP addressing, subnetting, and routing, to configuring network devices such as routers, switches, and firewalls. The program also includes hands-on experience with industry-standard tools like Cisco Packet Tracer and Wireshark to help you analyze and troubleshoot real-world network issues. By the end of the course, you will have the skills, knowledge, and confidence to design, secure, and maintain small to medium-sized networks, establishing a strong foundation for a successful career in networking or cybersecurity.
</p>
...
<div className="fixed bottom-6 left-6 z-50">
  <div className="p-4 backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl text-center shadow-xl animate-glow">
